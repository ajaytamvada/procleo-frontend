    ...
    return (
      <div className="p-6">
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex items-start">
          ...
          <div>
            <h3 className="text-red-800 font-medium">Error Loading Direct POs</h3>
    ...
    <div className="h-full flex flex-col bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Direct Purchase Orders</h1>
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span className="font-medium">{filteredPOs.length} Direct PO{filteredPOs.length !== 1 ? 's' : ''}</span>
            </div>
            <button
          ...
          {filteredPOs.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">
                {searchTerm ? 'No matching Direct POs found' : 'No Direct POs yet'}
              </h3>
          ...
          <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <h4 className="text-sm font-medium text-blue-900">About Direct POs</h4>
                <p className="text-sm text-blue-700 mt-1">
                  Direct Purchase Orders are created without going through the PR/RFP workflow.
                  Use them for urgent purchases, small value procurements, or repeat orders from trusted suppliers.
                </p>
              </div>
            </div>
          </div>
