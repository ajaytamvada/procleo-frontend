        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center space-x-2 text-sm text-gray-600'>
            ...
            <span className='font-medium'>
              {filteredRFPs.length} Approved RFP
              ...
              <table className='min-w-full divide-y divide-gray-200'>
                ...
                <tbody className='bg-white divide-y divide-gray-200'>
                  {filteredRFPs.map((rfp: any) => {
                    ...
                    const selectedQuotation = rfp.quotations?.find(
                      (q: any) => q.isSelected
                    );
            ...
            <div className='flex items-start'>
              ...
              <div className='flex-1'>
                <h4 className='text-sm font-medium text-blue-900'>
                  About PO Creation from RFP
                </h4>
                <p className='text-sm text-blue-700 mt-1'>
                  Click "Create PO" to generate a Purchase Order with pre-filled
                  vendor and item details from the selected quotation. You can
                  review and modify the details before finalizing the PO.
                </p>
              </div>
            </div>
          </div>
