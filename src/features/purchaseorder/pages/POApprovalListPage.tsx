...
export const POApprovalListPage: React.FC = () => {
  ...
  const { data: pendingPOs = [], isLoading, error } = usePurchaseOrdersByStatus(POStatus.SUBMITTED);
    ...
    <div className="h-full flex flex-col bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Approve Purchase Orders</h1>
          ...
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span className="font-medium">{filteredPOs.length} Pending PO{filteredPOs.length !== 1 ? 's' : ''}</span>
          </div>
        </div>
      </div>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center text-sm">
                          ...
                          <div>
                            ...
                            {po.supplierId > 0 && (
                              <div className="text-xs text-gray-500">ID: {po.supplierId}</div>
                            )}
                          </div>
                        </div>
                      </td>
          ...
          <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <h4 className="text-sm font-medium text-blue-900">About PO Approval</h4>
                <p className="text-sm text-blue-700 mt-1">
                  Click "Review" to view full PO details including items, pricing, and shipping information.
                  You can approve or reject the purchase order with remarks.
                </p>
              </div>
            </div>
          </div>
