...
export const ModifyPOListPage: React.FC = () => {
  ...
  const { data: draftPOs = [], isLoading, error } = usePurchaseOrdersByStatus('DRAFT');
    ...
    return (
      <div className="p-6">
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex items-start">
          ...
          <div>
            <h3 className="text-red-800 font-medium">Error Loading Draft POs</h3>
    ...
    <div className="h-full flex flex-col bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Modify Purchase Orders</h1>
          ...
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span className="font-medium">{filteredPOs.length} Draft PO{filteredPOs.length !== 1 ? 's' : ''}</span>
          </div>
        </div>
      </div>
          ...
          <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <h4 className="text-sm font-medium text-blue-900">About Modifying POs</h4>
                <p className="text-sm text-blue-700 mt-1">
                  Draft purchase orders can be edited to update items, quantities, prices, delivery dates, and other details.
                  After making changes, you can save as draft or submit for approval.
                </p>
              </div>
            </div>
          </div>
