...
import { usePurchaseOrdersByStatus, useCancelPurchaseOrder } from '../hooks/usePurchaseOrders';
          ...
          <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <h4 className="text-sm font-medium text-yellow-900">About Cancelling POs</h4>
                <p className="text-sm text-yellow-700 mt-1">
                  Cancelling a purchase order will mark it as cancelled and prevent any further processing.
                  You must provide a reason for cancellation. This action cannot be undone.
                </p>
              </div>
            </div>
          </div>
