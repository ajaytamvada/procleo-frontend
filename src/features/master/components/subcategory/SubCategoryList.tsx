...
import type { SubCategory, SubCategoryFilters } from '../../hooks/useSubCategoryAPI';
      ...
      <div className="border-b border-gray-200 p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Manage sub-category master records</p>
          </div>
          <button
            onClick={onCreate}
      ...
      {totalPages > 0 && (
        <div className="p-4 border-t flex justify-between items-center">
          <div className="text-sm text-gray-600">
            Showing {page * 15 + 1}-{Math.min((page + 1) * 15, totalElements)} of {totalElements} records
          </div>
