...
import type { CostCenter, CostCenterFilters } from '../../hooks/useCostCenterAPI';
    ...
    <div className="bg-white rounded-lg shadow-md">
      ...
      <div className="border-b border-gray-200 p-6">
        <div className="flex justify-between items-center">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Cost Center Master</h2>
            <p className="text-sm text-gray-600 mt-1">Manage cost center master records</p>
          </div>
          <button
            onClick={onCreate}
              ...
              costCenters.map((costCenter, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-gray-900">{costCenter.name}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-700">{costCenter.code || '-'}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-700">{costCenter.departmentName || '-'}</div>
                  </td>
