...
const locationSchema = z.object({
  name: z.string().min(1, 'Location name is required').max(110, 'Location name cannot exceed 110 characters'),
  code: z.string().min(1, 'Location code is required').max(70, 'Location code cannot exceed 70 characters'),
});
