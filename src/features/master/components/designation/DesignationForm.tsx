...
import type { Designation } from '../../hooks/useDesignationAPI';

const designationSchema = z.object({
  name: z.string().min(1, 'Designation name is required').max(100, 'Designation name cannot exceed 100 characters'),
        ...
        <div className="space-y-6 max-w-2xl">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Enter designation name (e.g., Manager, Engineer)"
              disabled={isSubmitting}
            />
            {errors.name && (
          ...
          <div>
            ...
            <input
              ...
              placeholder="Enter designation code (e.g., MGR, ENG)"
              disabled={isSubmitting}
            />
            {errors.code && (
