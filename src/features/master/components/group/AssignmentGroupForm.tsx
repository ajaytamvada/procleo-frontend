...
import { useCreateAssignmentGroup, useUpdateAssignmentGroup } from '../../hooks/useAssignmentGroupAPI';
...
const AssignmentGroupForm: React.FC<AssignmentGroupFormProps> = ({ group, onClose, onSuccess }) => {
  ...
  const isLoading = createMutation.isPending || updateMutation.isPending || loadingEmployees;
