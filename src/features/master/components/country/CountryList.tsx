  ...
  return (
    <div className='min-h-screen bg-[#f8f9fc] p-2'>
      ...
      <div className='flex items-center justify-between mb-6'>
        <div>
          <h1 className='text-xl font-semibold text-gray-900'>Country</h1>
          <p className='text-sm text-gray-500 mt-0.5'>
            Manage country master records
          </p>
        </div>
        <button
          onClick={onCreate}
      ...
      <div className='bg-white rounded-lg border border-gray-200 overflow-hidden'>
        <div className='overflow-x-auto'>
          {isLoading ? (
            <div className='flex flex-col items-center justify-center py-16'>
              ...
              <p className='text-sm text-gray-500 mt-3'>Loading countries...</p>
            </div>
          ) : countries.length === 0 ? (
            <div className='flex flex-col items-center justify-center py-16'>
              ...
              <p className='text-gray-600 font-medium'>No countries found</p>
              <p className='text-gray-400 text-sm mt-1'>
                Click "New Country" to create one
              </p>
            </div>
          ) : (
        ...
        {/* Pagination */}
        {totalPages > 0 && !isLoading && countries.length > 0 && (
