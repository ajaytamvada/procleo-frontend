...
const buildingSchema = z.object({
  name: z.string().min(1, 'Building name is required').max(100, 'Building name cannot exceed 100 characters'),
  code: z.string().min(1, 'Building code is required').max(50, 'Building code cannot exceed 50 characters'),
});
