            ...
            {cities.length === 0 ? (
              <tr>
                <td colSpan={6} className="px-6 py-8 text-center text-gray-500">
                  No cities found. Click "New" to create one.
                </td>
              </tr>
            ) : (
              cities.map((city, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-700">{city.code}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-700">{city.stateName}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-700">{city.countryName}</div>
                  </td>
                    ...
                    <button
                      onClick={(e) => {
                        ...
                        if (
                          city.id &&
                          window.confirm(
                            `Are you sure you want to delete "${city.name}"? This will also delete all locations in this city.`
                          )
                        ) {
                          onDelete(city.id);
                        }
