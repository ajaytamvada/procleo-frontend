...
const PurchaseRequestList: React.FC<PurchaseRequestListProps> = ({
  ...
  const handleDelete = (id: number, requestNumber?: string) => {
    if (window.confirm(`Are you sure you want to delete purchase request "${requestNumber}"?`)) {
      onDelete(id!);
    }
  };
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        {isLoading ? (
          ...
          <div className="p-8 text-center text-gray-500">
            ...
            <p className="text-gray-500">No purchase requests found matching your criteria.</p>
          </div>
        ) : (
          <>
            ...
            <div className="bg-gray-50 px-6 py-3 flex items-center justify-between border-t border-gray-200">
              <div className="text-sm text-gray-700">
                Showing {page * 15 + 1} to {Math.min((page + 1) * 15, totalElements)} of{' '}
