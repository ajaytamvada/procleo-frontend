        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-4">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-semibold text-gray-800">Print Preview</h1>
            </div>
            <button
              onClick={handlePrint}
        ...
        <div ref={printRef} className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="info-section border-t border-b border-gray-300 py-6 mb-6">
            <div className="grid grid-cols-2 gap-6">
              <div>
                <div className="mb-3">
                  <span className="font-semibold text-gray-700">PR Number:</span>
                  <span className="ml-2 text-gray-900">{purchaseRequest.requestNumber}</span>
                </div>
                <div className="mb-3">
                  <span className="font-semibold text-gray-700">Request Date:</span>
                  <span className="ml-2 text-gray-900">
                    {new Date(purchaseRequest.requestDate).toLocaleDateString('en-GB')}
                  </span>
                </div>
                <div className="mb-3">
                  <span className="font-semibold text-gray-700">Requested By:</span>
                  <span className="ml-2 text-gray-900">{purchaseRequest.requestedBy}</span>
                </div>
              </div>
              <div>
                <div className="mb-3">
                  <span className="font-semibold text-gray-700">Status:</span>
                  <span className="ml-2 text-gray-900 uppercase">{purchaseRequest.status}</span>
                </div>
                <div className="mb-3">
            ...
            {purchaseRequest.remarks && (
              <div className="mt-4">
                ...
                <p className="mt-1 text-gray-900 whitespace-pre-wrap">{purchaseRequest.remarks}</p>
              </div>
            )}
          </div>
