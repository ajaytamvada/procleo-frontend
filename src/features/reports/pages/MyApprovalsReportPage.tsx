...
const MyApprovalsReportPage: React.FC = () => {
  ...
  const { data: reportData, isLoading } = useMyApprovalsReport(
    startDate,
    endDate
  );
  ...
  }, [reportData, searchTerm, decisionFilter]);
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [searchTerm, startDate, endDate, decisionFilter]);
  ...
  const handleExportToExcel = () => {
    ...
    try {
      exportMyApprovalsToExcel(filteredData);
    ...
    <div className='min-h-screen bg-[#f8f9fc] p-2'>
      ...
      <div className='mb-6'>
        ...
        <p className='text-sm text-gray-500 mt-0.5'>
          Records you have approved or rejected across all modules (last 90 days
          by default)
        </p>
      </div>
          ...
          <div>
            ...
            <div className='relative'>
              ...
              <input
                ...
                placeholder='Document no., module, remarks...'
              ...
              <tbody className='divide-y divide-gray-100'>
                {paginatedData.map((item, index) => (
                  ...
                  >
                    ...
                    <td className='px-4 py-3.5 text-sm text-gray-700 max-w-[280px] truncate'>
                      {item.remarks || '--'}
                    </td>
                  </tr>
                ))}
...
export default MyApprovalsReportPage;
