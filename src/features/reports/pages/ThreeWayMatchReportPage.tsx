                ...
                {paginatedData.map((item, index) => (
                  ...
                  >
                    ...
                    <td className='px-4 py-3.5 text-right text-sm font-semibold text-gray-900'>
                      ₹
                      {item.poValue.toLocaleString('en-IN', {
                    ...
                    <td className='px-4 py-3.5 text-right text-sm text-gray-700'>
                      ₹
                      {item.invoiceValue.toLocaleString('en-IN', {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      })}
                    </td>
                    <td className='px-4 py-3.5 text-right text-sm text-gray-700'>
                      ₹
                      {item.paymentValue.toLocaleString('en-IN', {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      })}
                    </td>
                    ...
                    <td className='px-4 py-3.5'>
                      <span
                        className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border ${getStatusBadgeClass(item.threeWayStatus)}`}
                      >
                        {item.threeWayStatus}
                      </span>
                    </td>
