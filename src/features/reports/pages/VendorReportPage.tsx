...
const VendorReportPage: React.FC = () => {
  ...
  return (
    <div className='min-h-screen bg-[#f8f9fc] p-2'>
      {/* Page Header */}
      <div className='mb-6'>
        <h1 className='text-xl font-semibold text-gray-900'>Vendor Report</h1>
          ...
          <div>
            ...
            <div className='relative'>
              <select
                ...
                className='w-full px-4 py-2.5 text-sm border border-gray-200 rounded-lg bg-white appearance-none focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500'
              >
              ...
              <tbody className='divide-y divide-gray-100'>
                {paginatedData.map((item, index) => (
                  ...
                  >
                    ...
                    <td className='px-4 py-3.5 text-right text-sm text-gray-700'>
                      ₹
                      {item.totalPaymentAmount.toLocaleString('en-IN', {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      })}
                    </td>
                    <td className='px-4 py-3.5 text-right text-sm font-semibold text-amber-600'>
                      ₹
