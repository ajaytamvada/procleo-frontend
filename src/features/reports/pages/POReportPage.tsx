...
import { usePOReport } from '../hooks/useReports';
import { exportPOReportToExcel } from '../utils/excelExport';

const POReportPage: React.FC = () => {
  ...
  const { data: reportData, isLoading } = usePOReport(startDate, endDate);
  ...
  const handleExportToExcel = () => {
    ...
    try {
      exportPOReportToExcel(filteredData);
    ...
    <div className='min-h-screen bg-[#f8f9fc] p-2'>
      ...
      <div className='mb-6'>
        ...
        <p className='text-sm text-gray-500 mt-0.5'>
          View and analyze purchase order data
        </p>
      </div>
          ...
          <div className='md:col-span-2'>
            ...
            <div className='relative'>
              ...
              <input
                ...
                placeholder='Search by PO Number, Vendor, PR Number...'
              ...
              <tbody className='divide-y divide-gray-100'>
                {paginatedData.map((item, index) => (
                  ...
                  >
                    ...
                    <td className='px-4 py-3.5'>
                      <p className='text-sm text-gray-900'>{item.vendorName}</p>
