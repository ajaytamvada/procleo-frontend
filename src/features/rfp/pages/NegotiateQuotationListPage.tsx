...
export const NegotiateQuotationListPage: React.FC = () => {
  ...
  const { data: rfps = [], isLoading, error } = useRFPsForEvaluation();
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600">Compare and negotiate quotations</p>
          </div>
        </div>
      </div>
          ...
          {filteredRFPs.length === 0 ? (
            <div className="p-8 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-1">
                {searchTerm ? 'No matching RFPs found' : 'No RFPs available for evaluation'}
              </h3>
