          ...
          <div className='flex items-center space-x-3'>
            ...
            <div>
              ...
              <p className='text-sm text-gray-600'>
                Manage Request for Proposal workflow from creation to completion
              </p>
            </div>
          </div>
    ...
    <div className='p-6'>
      <div className='bg-white rounded-lg border border-gray-200 p-6'>
        ...
        <p className='text-gray-600 mb-6'>
          Manage RFP responses, conduct negotiations, handle re-submissions, and
          preview quotations.
        </p>
          ...
          <div className='space-y-4'>
            ...
            <div className='space-y-3'>
              <div className='border border-gray-200 rounded-lg p-4 hover:bg-gray-50 cursor-pointer'>
                ...
                <p className='text-sm text-gray-600'>
                  Office Renovation - In negotiation
                </p>
                <div className='mt-2'>
  ...
  return (
    <div className='p-6'>
      <div className='bg-white rounded-lg border border-gray-200 p-6'>
        ...
        <p className='text-gray-600 mb-6'>
          Send RFPs for final approval and generate comprehensive summaries and
          reports.
        </p>
