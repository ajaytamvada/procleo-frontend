    ...
    useEffect(() => {
        if (rfp) {
            setFormData({
                ...
                requestDate: rfp.requestDate ? rfp.requestDate.toString().split('T')[0] : '',
                closingDate: rfp.closingDate ? rfp.closingDate.toString().split('T')[0] : '',
        ...
        <div className='min-h-screen bg-gray-50'>
            ...
            <div className='bg-white border-b border-gray-200 px-6 py-4'>
                <div className='flex items-center justify-between'>
                    <div className='flex items-center space-x-4'>
                        ...
                        <h1 className='text-xl font-semibold text-gray-900'>Edit RFP - {rfp?.rfpNumber}</h1>
                    </div>
            ...
            <div className='max-w-7xl mx-auto px-6 py-6'>
                ...
                <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6'>
                    <h2 className='text-lg font-semibold text-gray-900 mb-4'>RFP Details</h2>
