...
import { Plus, Search, Filter, Eye, Edit, CheckCircle, XCircle, FileText, DollarSign, AlertCircle } from 'lucide-react';
      ...
      const mockData: Invoice[] = [
        {
          ...
          supplierInvoiceDate: '2024-09-15',
          invoiceType: InvoiceType.STANDARD,
          status: InvoiceStatus.THREE_WAY_MATCHED,
        ...
        {
          id: 3,
          invoiceNumber: 'INV/2024-2025/003',
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Manage supplier invoices and payments</p>
        </div>
        <button
                ...
                invoices.map((invoice) => (
                  <tr key={invoice.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          {invoice.supplierInvoiceNumber && (
                            <div className="text-xs text-gray-500">Ref: {invoice.supplierInvoiceNumber}</div>
                          )}
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      ...
                      {invoice.poNumber && (
                        <div className="text-xs text-blue-600">PO: {invoice.poNumber}</div>
                      )}
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center text-sm">
                        ...
                        <span className={isOverdue(invoice.dueDate, invoice.status) ? 'text-red-600 font-medium' : 'text-gray-900'}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm">
                        <div className="text-gray-900">₹ {invoice.balanceAmount?.toLocaleString('en-IN') || '0'}</div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      <div className="flex items-center space-x-2">
                        ...
                        {invoice.status === InvoiceStatus.SUBMITTED && invoice.poNumber && invoice.grnNumber && (
                          <button
