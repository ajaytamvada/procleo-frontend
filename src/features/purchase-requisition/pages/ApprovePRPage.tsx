  ...
  if (error) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-500">Failed to load pending approvals. Please try again.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">Pending For Approval</h1>
      </div>
      ...
      {pendingPRs.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">No purchase requisitions pending for approval.</p>
        </div>
      ) : (
        <>
              ...
              <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                  <p className="text-sm text-gray-700">
                    ...
                    <span className="font-medium">{Math.min(endIndex, filteredPRs.length)}</span> of{' '}
                    <span className="font-medium">{filteredPRs.length}</span> results
                  </p>
                </div>
                <div>
      ...
      {selectedPrId && (
        <PRApprovalDetailDialog prId={selectedPrId} onClose={handleCloseDialog} />
      )}
    </div>
  );
};