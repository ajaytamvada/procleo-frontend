...
import { usePRDetailsForApproval, useApprovePRItems } from '../hooks/useApproval';
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-8 max-w-md">
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Error Loading PR Details</h3>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div>
                <label className="text-xs text-gray-500 font-medium">Request Date</label>
              ...
              <div>
                <label className="text-xs text-gray-500 font-medium">Employee Code</label>
              ...
              <div>
                <label className="text-xs text-gray-500 font-medium">Purchase Type</label>
              ...
              {prDetails.projectCode && (
                <>
                  <div>
                    ...
                    <p className="text-sm text-gray-900">{prDetails.projectCode}</p>
                  </div>
                  <div>
                    <label className="text-xs text-gray-500 font-medium">Project Name</label>
                    <p className="text-sm text-gray-900">{prDetails.projectName}</p>
                  </div>
                </>
              )}
              {prDetails.remarks && (
          ...
          {/* Items Table */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Items for Approval</h3>
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <Input
                            ...
                            value={item.quantity}
                            onChange={(e) =>
                              updateItemField(item.itemId, 'quantity', Number(e.target.value))
                            }
                            className="w-20"
                            min="1"
                          />
                        ...
                        <td className="px-4 py-3">
                          <Input
                            ...
                            onChange={(e) =>
                              updateItemField(item.itemId, 'unitPrice', Number(e.target.value))
                            }
                            className="w-24"
                            min="0"
                            step="0.01"
