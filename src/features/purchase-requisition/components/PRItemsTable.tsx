...
export const PRItemsTable: React.FC<PRItemsTableProps> = ({
  ...
  const handleInputChange = (index: number, field: string, value: any) => {
    ...
    const updatedItem = {
      ...
      [field]:
        field === 'quantity' || field === 'indicativePrice'
          ? Number(value)
          : value,
    };
    ...
    return (
      <div className='border border-gray-200 rounded-lg p-8 text-center'>
        <p className='text-gray-500'>
          No items added yet. Click "Add New Line Item" to get started.
        </p>
      </div>
    );
  }
            ...
            <tr key={item.id}>
              ...
              <td className='px-3 py-2'>
                ...
                {errors?.[index]?.subCategory && (
                  <p className='mt-1 text-xs text-red-600'>
                    {errors[index].subCategory.message}
                  </p>
                )}
              </td>
              <td className='px-3 py-2'>
              ...
              <td className='px-3 py-2'>
                <Input
                  ...
                  onChange={e =>
                    handleInputChange(index, 'indicativePrice', e.target.value)
                  }
                  placeholder='0.00'
                  min='0'
                  step='0.01'
