...
import { Plus, Search, Filter, Eye, Edit, CheckCircle, XCircle, Package, FileText, Truck } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Manage goods receipts and quality checks</p>
        </div>
        <button
                ...
                grns.map((grn) => (
                  <tr key={grn.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="text-sm text-gray-900">{grn.supplierName}</div>
                      {grn.deliveryChallanNumber && (
                        <div className="text-xs text-gray-500">DC: {grn.deliveryChallanNumber}</div>
                      )}
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      <div className="flex items-center space-x-2">
                        ...
                        {grn.status === GRNStatus.APPROVED && !grn.isInvoiceCreated && (
                          <button
