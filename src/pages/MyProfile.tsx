...
const MyProfile: React.FC = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'profile':
        return (
          <form className='space-y-8' onSubmit={handleSubmitProfile(onProfileSubmit)}>
            {/* Profile Picture */}
            <div className='flex items-center gap-6 pb-6 border-b border-gray-100'>
              ...
              <div>
                ...
                <p className='text-sm text-gray-500'>
                  {user?.designation} {user?.designation && user?.departmentName ? '•' : ''} {user?.departmentName}
                </p>
              </div>
            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <div>
                ...
                />
                {profileErrors.firstName && <p className={errorClass}>{profileErrors.firstName.message as string}</p>}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={inputClass}
                />
                {profileErrors.lastName && <p className={errorClass}>{profileErrors.lastName.message as string}</p>}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={inputClass}
                />
                {profileErrors.email && <p className={errorClass}>{profileErrors.email.message as string}</p>}
              </div>
      ...
      case 'security':
        return (
          <form className='space-y-6 max-w-xl' onSubmit={handleSubmitPassword(onPasswordSubmit)}>
            <div>
              <label className='block text-sm font-medium text-gray-600 mb-1'>
                Current Password
              </label>
              <input
                ...
                className={inputClass}
              />
              {passwordErrors.currentPassword && <p className={errorClass}>{passwordErrors.currentPassword.message as string}</p>}
            </div>
            ...
            <div>
              ...
              <input
                ...
                className={inputClass}
              />
              {passwordErrors.newPassword && <p className={errorClass}>{passwordErrors.newPassword.message as string}</p>}
            </div>
            ...
            <div>
              ...
              <input
                ...
                className={inputClass}
              />
              {passwordErrors.confirmPassword && <p className={errorClass}>{passwordErrors.confirmPassword.message as string}</p>}
            </div>
            ...
            {[
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm font-medium transition-colors ${activeTab === item.key
