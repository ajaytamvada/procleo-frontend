...
import { Bell, User, Menu, Plus, FileText, ShoppingCart, Users, ChevronDown, LogOut, Settings, UserCircle } from 'lucide-react';
          ...
          {isDropdownOpen && (
            <div className="absolute right-0 mt-2 w-72 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50 animate-in slide-in-from-top-2 duration-200">
              <div className="px-4 py-2 border-b border-gray-100">
                ...
                <p className="text-xs text-gray-500 mt-1">Create new procurement items</p>
              </div>
              ...
              {shortcuts.map((shortcut) => {
                ...
                return (
                  ...
                  >
                    <div className={`w-8 h-8 bg-gradient-to-r ${shortcut.color} rounded-md flex items-center justify-center group-hover:scale-105 transition-transform duration-200 shadow-sm`}>
                      <IconComponent className="w-4 h-4 text-white" />
                    </div>
                    <div className="flex-1">
                      <div className="text-sm font-medium text-gray-900">{shortcut.label}</div>
