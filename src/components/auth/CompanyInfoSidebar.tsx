...
const testimonials = [
  ...
  {
    quote:
      'The real-time analytics and reporting features have given us unprecedented visibility into our procurement operations.',
...
const achievements = [
  ...
  },
  {
    ...
    description: 'Government Approved Vendor',
  },
];
...
export function CompanyInfoSidebar({
  ...
  return (
    <div
      ...
      style={{
        background:
          'linear-gradient(135deg, #1a0b2e 0%, #2d1f4e 50%, #3a2b5e 100%)',
      }}
    >
      {/* Animated Background Elements */}
      <div className='absolute inset-0 overflow-hidden'>
        <div
          className='absolute -top-10 -right-10 w-40 h-40 rounded-full opacity-10 animate-pulse'
          style={{
        ...
        />
        <div
          className='absolute top-1/3 -left-20 w-60 h-60 rounded-full opacity-10'
          style={{
            background: 'radial-gradient(circle, #6366f1 0%, transparent 70%)',
      ...
      <div
        className='relative h-full flex items-center justify-center p-6 lg:p-8'
              ...
              <div key='overview' className='section-enter'>
                ...
                <div className='space-y-3 mb-10'>
                  <h3 className='text-xl font-semibold mb-5'>
                    {variant === 'vendor'
                      ? 'Why Partner with RiditStack?'
                      : 'Why Choose Autovitica P2P?'}
                  </h3>
                    ...
                    <>
                      <div className='flex items-start p-3 rounded-lg transition-all duration-300 hover:bg-white/10 hover:transform hover:translate-x-2'>
                        ...
                        <div>
                          ...
                          <p className='text-sm opacity-70'>
                            Join our network of verified vendors and grow your
                            business
                          </p>
                        </div>
                      </div>
                      <div className='flex items-start p-3 rounded-lg transition-all duration-300 hover:bg-white/10 hover:transform hover:translate-x-2'>
                        ...
                        <div>
                          ...
                          <p className='text-sm opacity-70'>
                            Automated payment processing with guaranteed
                            timelines
                          </p>
                        </div>
                      </div>
                      <div className='flex items-start p-3 rounded-lg transition-all duration-300 hover:bg-white/10 hover:transform hover:translate-x-2'>
                        ...
                        <div>
                          ...
                          <p className='text-sm opacity-70'>
                            Access to large enterprise procurement opportunities
                          </p>
                        </div>
                      </div>
                    </>
                    ...
                    <>
                      <div className='flex items-start p-3 rounded-lg transition-all duration-300 hover:bg-white/10 hover:transform hover:translate-x-2'>
                        ...
                        <div>
                          ...
                          <p className='text-sm opacity-70'>
                            Complete P2P lifecycle management in one platform
                          </p>
                        </div>
                      </div>
                      <div className='flex items-start p-3 rounded-lg transition-all duration-300 hover:bg-white/10 hover:transform hover:translate-x-2'>
