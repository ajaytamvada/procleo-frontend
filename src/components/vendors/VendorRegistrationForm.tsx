            ...
            <React.Fragment key={step}>
              <div className='flex items-center'>
                <div
                  ...
                  style={
                    currentStep >= step ? { backgroundColor: '#6366f1' } : {}
                  }
                >
        ...
        {currentStep === 3 && (
          <div className='space-y-4'>
            ...
            <Alert variant='info' className='text-sm py-2'>
              This information is required for payment processing and will be
              kept confidential.
            </Alert>
        ...
        {currentStep === 4 && (
          <div className='space-y-4'>
            ...
            <Alert className='text-sm py-2'>
              ...
              authorize Procleo to verify the provided information.
            </Alert>
          </div>
        )}
