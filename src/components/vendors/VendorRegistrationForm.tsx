...
const vendorRegistrationSchema = z.object({
  ...
  vendorType: z.enum(['supplier', 'service_provider', 'contractor', 'consultant']),
...
export function VendorRegistrationForm() {
  ...
  const nextStep = async () => {
    ...
    switch (currentStep) {
      case 1:
        fieldsToValidate = ['companyName', 'registrationNumber', 'taxId', 'vendorType'];
        break;
      case 2:
        fieldsToValidate = ['contactPerson', 'email', 'phone', 'address', 'city', 'state', 'country', 'postalCode'];
        break;
      case 3:
      ...
      <Card>
        <div className="p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold mb-2" style={{ color: '#1a0b2e' }}>Vendor Registration</h2>
            <p className="text-gray-600">Join Autovitica P2P as a trusted vendor</p>
          </div>
                ...
                <React.Fragment key={step}>
                  <div className="flex items-center">
                    <div
                      ...
                      style={currentStep >= step ? { backgroundColor: '#6366f1' } : {}}
                    >
                  ...
                  {step < 4 && (
                    <div className="flex-1 h-0.5 mx-4"
                      style={{ backgroundColor: currentStep > step ? '#6366f1' : '#E5E7EB' }}
                    />
                  )}
                </React.Fragment>
              ))}
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            {currentStep === 2 && (
              <div className="space-y-6">
                <h3 className="text-xl font-semibold mb-4">Contact & Address Information</h3>
            ...
            {currentStep === 3 && (
              <div className="space-y-6">
                ...
                <Alert variant="info">
                  This information is required for payment processing and will be kept confidential.
                </Alert>
            ...
            {currentStep === 4 && (
              <div className="space-y-6">
                  ...
                  <Card className="p-4">
                    ...
                    <dl className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                      ...
                      <div>
                        ...
                        <dd className="font-medium">{watch('registrationNumber')}</dd>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <dd className="font-medium capitalize">{watch('vendorType')?.replace('_', ' ')}</dd>
                      </div>
                    </dl>
                  </Card>
                  ...
                  <Card className="p-4">
                    ...
                    <dl className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                      <div>
                        ...
                        <dd className="font-medium">{watch('contactPerson')}</dd>
                      </div>
                      <div>
                  ...
                  <Card className="p-4">
                    ...
                    <dl className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                      ...
                      <div>
                        ...
                        <dd className="font-medium">****{watch('accountNumber')?.slice(-4)}</dd>
                      </div>
                    </dl>
                  </Card>
                </div>
                ...
                <Alert>
                  By submitting this form, you agree to our terms and conditions and authorize Autovitica to verify the provided information.
                </Alert>
              </div>
            )}
